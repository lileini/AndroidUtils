...
public class LogUtil {
    ...
    private final static SimpleDateFormat LOG_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");// 日志的输出格式
...
//        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + MainApp.getMainApp().getPackageName();
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath()+File.separator+ "快启"+File.separator+"log";
        LOG_FILE_NAME = "Log";
...
//        Log.i(LOG_TAG,"BuildConfig.DEBUG: "+BuildConfig.DEBUG);
    ...
    private synchronized static void log2File(String mylogtype, String tag, String text) {
        ...
        File file = new File(LOG_FILE_PATH, LOG_FILE_NAME + date+".log");
        try {
